...
describe('StockLabel', () => {
  describe('constructor()', () => {
    ...
    describe('when label is null', () => {
      it('should throw an error', () => {
        expect(() => new StockLabel(null as any)).toThrow('Stock label must be a string.');
      });
    });

    describe('when label is undefined', () => {
      it('should throw an error', () => {
        expect(() => new StockLabel(undefined as any)).toThrow('Stock label must be a string.');
      });
    });

    describe('when label is a number', () => {
      it('should throw an error', () => {
        expect(() => new StockLabel(123 as any)).toThrow('Stock label must be a string.');
      });
    });
  });
