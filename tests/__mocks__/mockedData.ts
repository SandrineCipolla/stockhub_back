...
import {createFakeDatabaseConnection} from "./connectionUtils";
...
export const mockWriteRepo = new WriteStockRepository(createFakeDatabaseConnection()) as jest.Mocked<WriteStockRepository>;