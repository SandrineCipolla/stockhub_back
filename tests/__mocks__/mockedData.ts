...
export const mockReadRepo = new ReadStockRepository() as jest.Mocked<ReadStockRepository>;

export const mockWriteRepo = new WriteStockRepository() as jest.Mocked<WriteStockRepository>;
