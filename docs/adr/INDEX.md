...
| [ADR-021](./ADR-021-conversion-hexagonale-authorize-middleware.md) | Conversion hexagonale du middleware d'autorisation (alternative à ADR-019) | 2026-09-09 | 📝 Proposé |

> Numérotation **globale au projet**, partagée avec le frontend et alignée sur la séquence unique du [wiki](https://github.com/SandrineCipolla/stockHub_V2_front/wiki/Architecture-Decision-Records) : ADR-001, ADR-002, ADR-004 à ADR-012 et ADR-020 sont des décisions frontend (voir `stockHub_V2_front/docs/adr/`), donc le prochain numéro libre se choisit après ADR-021, pas après ADR-019.
