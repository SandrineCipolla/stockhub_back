...
export const HTTP_CODE_CONFLICT = 409;// conflit dans la requête envoyée au serveur (ex création d'une ressource ayant les même données qu'une ressource existante
